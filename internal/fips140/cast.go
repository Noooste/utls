...
//
//go:linkname fatal github.com/Noooste/utls/internal/fips140.fatal
func fatal(string)
...
// be added to github.com/Noooste/utls/internal/fips140test. If a package p calls CAST on the first
