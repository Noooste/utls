...
func Supported() error {
	...
	// github.com/Noooste/utls/internal/fips140deps and then call it to unpoison the range
...
//
// It's only here because [github.com/Noooste/utls/internal/fips140/ecdsa.TestingOnlyNewDRBG]
